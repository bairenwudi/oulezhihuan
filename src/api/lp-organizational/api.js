...
export const updateByIdArea = params => {
    return axios.post(`${baseUrl.base3}/Zh_zone_infoController/updateById`, params);
}

// 批量删除(区域)
export const deleteByIds = params => {
    return axios.post(`${baseUrl.base3}/Zh_zone_infoController/deleteByIds`, params);
}

// 批量删除(楼栋)
export const deleteByIdsBuilding = params => {
    return axios.post(`${baseUrl.base3}/Zh_building_infoController/deleteByIds`, params);
}

// 移动楼栋
export const updateByIds = params => {
    return axios.post(`${baseUrl.base3}/Zh_building_infoController/updateByIds`, params);
}

// 查询楼栋
export const selectBuildings = params => {
    return axios.post(`${baseUrl.base3}/Zh_building_infoController/selectBuildings`, params);
}

// 楼栋添加 传名字和父级区域id
export const buildingSave = params => {
    return axios.post(`${baseUrl.base3}/Zh_building_infoController/save`, params);
}

// 编辑楼栋名称
export const updateBuildingName = params => {
    return axios.post(`${baseUrl.base3}/Zh_building_infoController/updateBuildingName`, params);
}

// 查询楼层  传入楼栋id(building_id)
export const selectAllFloors = params => {
    return axios.post(`${baseUrl.base3}/Zh_floor_infoController/selectAllFloors`, params);
}

// 楼层添加 传名字和父级区域id
export const floorSave = params => {
    return axios.post(`${baseUrl.base3}/Zh_floor_infoController/save`, params);
}

// 楼层移动
export const updateByIdsFloor = params => {
    return axios.post(`${baseUrl.base3}/Zh_floor_infoController/updateByIds`, params);
}

// 批量删除(楼层)
export const deleteByIdsFloor = params => {
    return axios.post(`${baseUrl.base3}/Zh_floor_infoController/deleteByIds`, params);
}

// 编辑楼层名称
export const updateFloorName = params => {
    return axios.post(`${baseUrl.base3}/Zh_floor_infoController/updateFloorName`, params);
}

// 添加房间
export const saveRoom = params => {
    return axios.post(`${baseUrl.base3}/Zh_room_infoController/save`, params);
}
...
export const selectRooms = params => {
    return axios.post(`${baseUrl.base3}/Zh_room_infoController/selectRooms`, params);
}

// 批量删除 (房间)
export const deleteByIdsRoom = params => {
    return axios.post(`${baseUrl.base3}/Zh_room_infoController/deleteByIds`, params);
}

// 编辑房间名称
export const updateRoomName = params => {
    return axios.post(`${baseUrl.base3}/Zh_room_infoController/updateRoomName`, params);
}

// 房间移动
export const updateByIdsRoom = params => {
    return axios.post(`${baseUrl.base3}/Zh_room_infoController/updateByIds`, params);
}
...
export const selectNowRoomPrice = params => {
    return axios.post(`${baseUrl.base3}/Zh_room_type_priceController/selectNowRoomPrice`, params);
}

// 添加方案 org_id //机构id project_name //方案名称 start_time //开始时间 end_time //结束时间
export const saveRoomPrice = params => {
    return axios.post(`${baseUrl.base3}/Zh_room_type_priceController/save`, params);
}

// 显示列表
export const showRoomPriceList = params => {
    return axios.post(`${baseUrl.base3}/Zh_room_type_priceController/showRoomPriceList?pageSize=10`, params);
}
