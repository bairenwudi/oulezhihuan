...
const RefundListinfo = params => {
    return axios.post(`${baseUrl.base2}/Refund/select_refund_info`, params);
};

// 退款单详情列表-入住人
const RefundListCustomerinfo = params => {
    return axios.post(`${baseUrl.base2}/Refund/customerList?startPos=${params.startPos}&pageSize=10`, params);
};
...
const checkoutListinfo = params => {
    return axios.post(`${baseUrl.base2}/check/select_check_info`, params);
};
...
const checkoutListAgree = params => {
    return axios.post(`${baseUrl.base2}/check/agree`, params);
};
...
const daoruExcel = params => {
    return axios.post(`${baseUrl.base2}/Occupant_infoController/saveExcel`, params);
}
...
const delReserve = params => {
    return axios.post(`${baseUrl.base2}/BatchReserveController/deleteBatchReserve`, params);
}
//批量预定   点击编辑获取信息 
const getEditMsgReserve = params => {
    return axios.post(`${baseUrl.base2}/BatchReserveController/selectRoom`, params);
}
//批量预定   编辑
const editReserve = params => {
    return axios.post(`${baseUrl.base2}/BatchReserveController/updateBatchReserve`, params);
}
...
const batchCheckoutList = params => {
    return axios.post(`${baseUrl.base2}/BatchReserveController/reserveList1?startPos=${params.startPos}&pageSize=10`, params);
};

//批量审核   详情 和 处理
const detailAndDeal = params => {
    return axios.post(`${baseUrl.base2}/BatchReserveController/reserveInfo`, params);
};
//批量审核   同意
const agree = params => {
